    ...
    return (
        <div className="bg-zinc-700 h-screen w-screen flex justify-center">
            <div className="w-1/3 h-2/3 bg-zinc-800 rounded-lg flex flex-col justify-center my-auto shadow-lg shadow-black">
                ...
                <input type='password' className="h-12 w-2/3 rounded-md bg-zinc-400 mx-auto text-white pl-2 mb-5 outline-none" onChange={(e) => { setPassword(e.target.value) }}></input>
                ...
                <p className="text-center text-white mt-5">Already have an account? <Link className="text-blue-600 hover:underline" to={'/'}>  Log in</Link></p>
            </div>
        </div>
    )
}
